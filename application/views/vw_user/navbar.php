 ...
 <body class="sb-nav-fixed">
     <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
         <!-- Navbar Brand-->
         <a class="navbar-brand ps-3" href="<?= base_url('Home/') ?>">Admin Pantai Geger</a>
         <!-- Sidebar Toggle-->
         ...
         <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
             <li class="nav-item dropdown">
                 ...
                 <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                     ...
                     <li><a class="dropdown-item" href=<?= base_url('Register/index') ?>>Register</a></li>
                     <li>
     ...
     <div id="layoutSidenav">
         <div id="layoutSidenav_nav">
             <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                 <div class="sb-sidenav-menu">
                     <div class="nav">
                         ...
                         <a class="nav-link active" href="<?= base_url('Home/') ?>">
                             <div class="sb-nav-link-icon active"><i class="fas fa-tachometer-alt"></i>
                                </div>
                                Admin
                            </a>
                 ...
                 <a class="nav-link active" href="<?= base_url('C_galeri/') ?>">
                     <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                     Data Galeri
                 </a>
                 <a class="nav-link active" href="<?= base_url('C_komentar/') ?>">
                     <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                     Data Komentar
                 </a>
